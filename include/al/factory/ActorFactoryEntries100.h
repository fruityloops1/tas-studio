...
#include "fl/ca/JumpFlipPanel.h"
#include "fl/ca/NoJumpSwitch.h"
#include "fl/ca/PurpleCoinWatcher.h"
#include "game/Actors/Shine.h"
#include "game/Actors/TestAndoNpcIk.h"
...
template <typename T>
al::LiveActor* createCustomActorFunction(const char* name)
{
    return new T(name);
}
} // namespace al

constexpr al::NameToCreator<al::createActor> actorEntries[] = {
    { "PurpleCoinWatcher", &al::createCustomActorFunction<class fl::ca::PurpleCoinWatcher> },
    { "JumpFlipPanel", &al::createCustomActorFunction<class fl::ca::JumpFlipPanel> },
    { "NoJumpSwitch", &al::createCustomActorFunction<class fl::ca::NoJumpSwitch> },
