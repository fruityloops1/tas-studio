...
#define NERVE_IMPL_SUBCLASS_(Class, Subclass, Action, ActionFunc)          \
    void Subclass##Nrv##Action::execute(al::NerveKeeper* keeper)           \
    {                                                                      \
        static_cast<Class::Subclass*>(keeper->mParent)->exe##ActionFunc(); \
    }
#define NERVE_IMPL(Class, Action) NERVE_IMPL_(Class, Action, Action)
#define NERVE_IMPL_SUBCLASS(Class, Subclass, Action) NERVE_IMPL_SUBCLASS_(Class, Subclass, Action, Action)
